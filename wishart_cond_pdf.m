...
% Compute the density of the Wishart distribution 
...
function [pdf,logpdf] = wishart_cond_pdf(X, p_1, p_2, m, S)

    [~, AA] = wishpdf(X, p_1+p_2, m, S) ; 
    [~, BB] = wishpdf(X(1:p_1,1:p_1), p_1, m, S(1:p_1,1:p_1)) ; 
